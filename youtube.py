...
icon = Image.open(r"D:\GUVI\Youtube_project\youtube_logo.png")
st.set_page_config(page_title="Youtube Data Harvesting and Warehousing | By NARESH",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This app is created by *NARESH!*"""})
...
conmongo = pymongo.MongoClient("mongodb://localhost:27017/")
db = conmongo['youtube_data']
...
api_key = "AIzaSyDp2iaeevd0Fpmv5W5kDyyisQPy4VmC2ls"  # "AIzaSyDp2iaeevd0Fpmv5W5kDyyisQPy4VmC2ls"
...
if selected == "Home":
    # Title Image
    st.image(r"D:\GUVI\Youtube_project\youtube_logo.png")
